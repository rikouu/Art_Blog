...
<head>
    ...
    <body>
                ...
                <div class="continar-left">
                    ...
                    <div class="xiaob">
                        ...
                        <p class="data-l">
                            ...
                            <span><i class="iconfont icon-liulan"></i><?php echo getPostViews(get_the_ID()); ?>次浏览</span>
                            <span>
                    ...
                    <div class="log-text">
                        ...
                        <?php endif; ?>
                        <p class="copy">「一年博客，如果觉得我的文章对您有用，请帮助本站成长」</p>
                        <!--文章打赏开始-->
        ...
        <!--文章打赏结束-->
        <div class="key-w">
            <div class="single_lable"><i class="iconfont" style="padding-right:3px">&#xe757;</i>标签：</div>
            <?php the_tags('','',''); ?>
        </div>
