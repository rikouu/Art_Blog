...
var date=[	
	{
		...
		reply:"前言 - 你因为他的一句话生气，自己生了很久的闷气，等着他来哄，也许到最后他根本都不知道自己哪句话说错了。原来，没人是你肚子里的蛔虫，沟通一定是最重要的，你生气，你不理他，你哭，只会让他觉得无理取闹，你以为他能明白，你以为他能理解，但是在他们眼里，只会觉得不知所谓。有的事你不说，他们永远也不会知道。。。网站PC端不再主动性提供登录登录注册快捷按钮，如需注册，用户可通过移动端访问网站——至左侧边栏——登录/注册，当然，你也可直接访问"+window.location.protocol+"//"+window.location.host+"/wp-login.php进行登录注册"
	},
	{
		message:"2019 - 04 - 15",
		reply:"很高兴在近日不遗余力坚持下，在保持打造高质量博客主题的同时，尽可能做到兼容IE9并已取得一定进展，这不仅仅是针对技术的挑战，更是希望尊重、珍惜每一位关注我博客的朋友，绝不希望因为有朋友因为低版本兼容问题遗憾而去放弃尝试使用它。未来，我还会考虑兼容到IE8，未来，我们一路同行！源码仓库地址：https://github.com/weipxiu/Art_Blog"
	},
	{
		message:"2019 - 04 - 14",
