...
function get_author_class($comment_author_email,$comment_author_url){
    ...
    echo '<a class="vp" target="_blank" href="https://www.weipxiu.com/category/about" title="经鉴定，管理员"></a>';
    ...
    echo '<a class="vip1" target="_blank" href="https://www.weipxiu.com/category/about" title="评论之星 LV.1"><i class="wi wi-level-1"></i></a>';
    else if($author_count>=5 && $author_count<10 && $comment_author_email!=$adminEmail)
    echo '<a class="vip2" target="_blank" href="https://www.weipxiu.com/category/about" title="评论之星 LV.2"><i class="wi wi-level-2"></i></a>';
    else if($author_count>=10 && $author_count<25 && $comment_author_email!=$adminEmail)
    echo '<a class="vip3" target="_blank" href="https://www.weipxiu.com/category/about" title="评论之星 LV.3"><i class="wi wi-level-3"></i></a>';
    else if($author_count>=25 && $author_count<50 && $comment_author_email!=$adminEmail)
    echo '<a class="vip4" target="_blank" href="https://www.weipxiu.com/category/about" title="评论之星 LV.4"><i class="wi wi-level-4"></i>/a>';
    else if($author_count>=50 && $author_count<100 && $comment_author_email!=$adminEmail)
    echo '<a class="vip5" target="_blank" href="https://www.weipxiu.com/category/about" title="评论之星 LV.5"><i class="wi wi-level-5"></i></a>';
    else if($author_count>=100 && $author_count<250 && $comment_author_email!=$adminEmail)
    echo '<a class="vip6" target="_blank" href="https://www.weipxiu.com/category/about" title="评论之星 LV.6"><i class="wi wi-level-6"></i></a>';
    else if($author_count>=250 && $comment_author_email!=$adminEmail)
    echo '<a class="vip7" target="_blank" href="https://www.weipxiu.com/category/about" title="评论之星 LV.7"><i class="wi wi-level-7"></i></a>';
    }
