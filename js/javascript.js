			...
			if (window.location.href == "http://www.weipxiu.com" || window.location.href == "http://www.weipxiu.com/") {
					...
					setTimeout(function(){
							...
							function Clos()
							{
								...
								setTimeout(function(){$("#curriculum").remove();},1000)
							};
					...
					$("#hide").show();
					$("html").css({"overflow-y":"visible","height":"auto","width":"auto"});
					$("body").css({"overflow-x":"hidden","height":"auto","width":"auto"});
					$(".buffer").fadeOut();
					$(".buffer .bar").hide();
					...
					//$("#music").get(0).play();
					setTimeout(function(){
						$("#vedio").animate({"bottom":"0"},1000);
						$(".hide").animate({"bottom":"193px"},1000);
					},3500);
				}else{
