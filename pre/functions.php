...
//     function pagenavi( $p = 3 ) { // 取当前页前后各 2 页，根据需要改
...
function ludou_comment_mail_notify($comment_id, $comment_status) {
  ...
  //主题升级
  require 'https://www.weipxiu.com/wp-content/themes/theme-updates/theme-update-checker.php';
    $myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
        'https://www.weipxiu.com/wp-content/themes/info.json',
        __FILE__,
        'boke'
    );
?>
