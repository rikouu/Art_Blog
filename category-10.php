...
<head>
    ...
    <div class="continar">
         <div class="continar-left" id="details">
             ...
             <ul class="clearfix">
                ...
                <p class="px">
                    此网站后台采用WordPress，前端模块完全自主开发(自主开发不代表不参考，如有雷同纯属巧合。。。)，运用大量js+css3运动，整体页面华丽的同时也会暗藏bug，尽快博主本人多次测试，但难免在众多设备或不同人不同见解下任有所不足之处，如有好的意见欢迎给我留言，博客会适当改进，慢慢改版。最后感谢大家的关注，尤其谢谢<a href="http://www.weipxiu.com/wp-content/themes/boke/thanks.html">各位</a>提供的帮助！
                </p>
                <!-- <p class="px">
    ...
    <script>
         ...
         $(".nav .nav-min a").removeClass("hover");

         $(".nav ul.music-nav li a span").removeClass("hover");
         $(".nav ul.music-nav li p").css("display","none");
         $(".nav ul.music-nav li a span").eq(14).addClass("hover");
         $(".nav ul.music-nav li a span").eq(15).parents(".nav ul li").find("p").css("display","block");
    </script>
</html>